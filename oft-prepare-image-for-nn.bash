...
version=1.01
#Added forcing to preserve original pixel size in re-projection
version=1.02
echo "     "
echo "=============================================================="
...
if [ $args -lt 1 ] ; then
    ...
    echo "If target projection is given, also shapefile is re-projected"
...
gdal_rasterize -a $attr -l $shapebase $shape $imagec"_mask."$extension
